...
<div class="modal fade right" id="agregarJuego" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  aria-hidden="true">
  ...
  <div class="modal-dialog modal-full-height" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <input type="text" name="" id="titulo0" class="form-control input-sm" autofocus required>

          <label for="">Descripción:</label>
          <input type="text" name="" id="descripcion0" class="form-control input-sm" required>

          <label for="">Imagen:</label>
          <img id="myimage0">
          <input type="file" id="imagen0" accept=".jpg,.png,.jpge,.tif, .jfif" onChange="onFileSelected(event, 0);" class="form-control input-sm" required>
          ...
          <div style="width: 100%; padding: 0.375rem 0.75rem; font-size: 1rem; font-weight: 400; line-height: 1.5; color: #6e707e; background-color: #fff; background-clip: padding-box; border: 1px solid #d1d3e2; border-radius: 0.35rem; transition: border-color 0.15s ease-in-out, box-shadow 0.15s ease-in-out;">
              ...
              <script type="text/javascript" defer>
                ...
                <script type="text/javascript" defer>
                    ...
                    input.setAttribute("onclick", "checkPlataforma(" + '<?php echo $mostrar['id'];?>' + ",0)");
                    input.setAttribute("id", '<?php echo $mostrar['id'];?>_0');
